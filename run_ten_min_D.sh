...
export RUN_ID=ten_min_D_6layer
...
python3 -u train_gpt.py > /tmp/ten_min_D_6layer.log 2>&1
echo "--- 10MIN D_6layer RESULT ---"
grep -E '\[stop\]|\[final\]\[quant_eval\]|step:[0-9]+ loss:' /tmp/ten_min_D_6layer.log | tail -30
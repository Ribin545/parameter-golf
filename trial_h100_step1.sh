#!/usr/bin/env bash
# =============================================================================
# trial_h100_step1.sh — H100 Step 1 progression run
# ONLY change from the historical winner: checkpoint mode -> minimal
# =============================================================================
set -euo pipefail
...
# Step 1: ONLY this changes from the historical winner

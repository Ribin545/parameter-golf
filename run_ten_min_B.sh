...
export RUN_ID=ten_min_B_aggrLR
...
python3 -u train_gpt.py > /tmp/ten_min_B_aggrLR.log 2>&1
echo "--- 10MIN RESULT ---"
grep -E '\[stop\]|\[final\]\[quant_eval\]|step:[0-9]+ loss:' /tmp/ten_min_B_aggrLR.log | tail -30
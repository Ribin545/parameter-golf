@echo off
REM C1 Gate: Parallel Residual Streams (75 iters) + DYNORM=1 baseline
setlocal
cd /d "%~dp0"
...
set RUN_ID=c1_parallel_residual_gate
set QUANT_EVAL=0
set SAVE_BEST_CHECKPOINT=0
set NO_PAUSE=1
echo =======================================================
echo C1 Gate: PARALLEL_RESIDUAL=1 (75 iters)
echo =======================================================

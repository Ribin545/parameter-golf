@echo off
REM H2: SmearGate + RECURRENCE_STEPS=2 (test depth compounding hypothesis)
setlocal
cd /d "%~dp0"
...
:: --- SmearGate ON + Recurrence depth=2 ---
set SMEARGATE_ENABLED=1
set SMEARGATE_ALPHA=0.08
set RECURRENCE_STEPS=2
...
set RUN_ID=smeargate_h2_depth2
set QUANT_EVAL=0
set SAVE_BEST_CHECKPOINT=0
set NO_PAUSE=1
echo =======================================================
echo H2: SmearGate + RECURRENCE_STEPS=2 (75 iters)
echo =======================================================

...
# H100: max batch — 450k tokens, no checkpointing, push VRAM to the limit
export SAFETY_CLAMP_DISABLE=1
export MICRO_BATCH_TOKENS=458752
...
echo "=========================================================================="
echo "  H100 (max batch)"
echo "  NO checkpointing, NO recompute, batch 458752, compile=default"
